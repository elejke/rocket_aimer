...
import vpython
# from vpython import *
from vpython.vpython import * # must import visual or vis first
#from vpython import graph
#.graph import * # import graphing features
...
#
# ball = sphere(pos=vector(-5, 0, 0), radius=0.1, color=color.red)
